---
description: Introducción a la serie XIAO de Seeed Studio
title: XIAO INTRODUCTION
keywords:
- xiao
image: https://files.seeedstudio.com/wiki/seeed_logo/logo_2023.png
slug: /es/SeeedStudio_XIAO_Series_Introduction
last_update:
  date: 01/27/2025
  author: Guillermo
---

# Seeed Studio INTRODUCCION XIAO
...
<div class="all_container">
    ...
    <div class="xiao_topic_page_font1">
        <font size={"2.1"}>La serie XIAO de Seeed Studio es una colección de microcontroladores (MCUs) del tamaño de un pulgar, diseñados específicamente para proyectos con limitaciones de espacio que requieren alto rendimiento y conectividad inalámbrica. Incorporando la esencia de plataformas de hardware populares como ESP32, RP2350, RP2040, nRF52840 y SAMD21, la serie XIAO compatible con Arduino es el conjunto de herramientas perfecto para que explores el aprendizaje automático en dispositivos pequeños (TinyML).</font>
    </div>
</div>
<br/> 
...
## Tabla de Comparación de la Serie XIAO de Seeed Studio
...
<font size={"2"}>
	...
	<tr>
	    ...
	    <td>Universal con gran estabilidad y compatibilidad</td>
        ...
        <td>Versión avanzada del XIAO ESP32S3 con cámara OV2640 y micrófono</td>
        <td>MCU Renesas de 32 bits ARM Cortex-M4, compatible con Arduino IDE</td>
        <td>Compatible con Matter, Open Thread, Zigbee, Bluetooth Low Energy (BLE 5.3), Bluetooth Mesh y comunicación propietaria en 2.4 GHz</td>
        <td>Versión avanzada del XIAO MG24 con sensores de aceleración de seis ejes y micrófono</td>
	</tr>
	<tr>
	    <th>Chip</th>
    ...
    <tr>
        ...
        <td align="center"><font size={"3"}>❌</font></td>
	    <td align="center"><font size={"3"}>❌</font></td>
	    <td align="center">IMU, Micrófono</td>
        <td align="center"><font size={"3"}>❌</font></td>
        <td align="center"><font size={"3"}>❌</font></td>
        <td align="center"><font size={"3"}>❌</font></td>
        <td align="center">Cámara OV2640, Micrófono</td>
        <td align="center"><font size={"3"}>❌</font></td>
        <td align="center"><font size={"3"}>❌</font></td>
        <td align="center">Six-axis acceleration sensors Acelerómetro de 6 ejes, Microphone</td>
	</tr>
    <tr>
...
As a growing ecosystem of Seeed Studio XIAO, we offer a wide range of add-ons, which are compatible with Seeed Studio XIAO Boards. [Explore more here](https://www.seeedstudio.com/xiao-series-page).

<div align="center"><img width={1000} src="https://files.seeedstudio.com/wiki/xiao_topicpage/add_on_accessories.png" /></div>

## Comenzando con XIAO de Seeed Studio

<table align="center">
<font size={"2"}>
    <tr>
        <th align="center"><strong>Wikis</strong></th>
        <th align="center"><strong>Book</strong></th>
        <th align="center"><strong>Fab Academy</strong></th>
        <th align="center"><strong>Video</strong></th>
        <th align="center"><strong>Courses</strong></th>
    </tr>
    <tr>
...
## Open-Source para XIAO de Seeed Studio

### Archivos de KiCad para la Serie XIAO
...
¡Gracias por elegir nuestros productos! Estamos aquí para brindarle diferentes tipos de soporte y asegurarnos de que su experiencia con nuestros productos sea lo más fluida posible. Ofrecemos varios canales de comunicación para adaptarnos a distintas preferencias y necesidades.
